#
#  Be sure to run `pod spec lint SwiftCron.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Keegan Rush"
  # s.authors            = { "Keegan Rush" => "galaxyplansoftware@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/Rush42/SwiftCron.git", :tag => "0.0.1" }
